  ...
  xml.channel do
    ...
    for article in @articles
      xml.item do
        ...
        xml.image do
          xml.url request.protocol+request.host+article.images.first.image.url(:detail) if article.images.first
          xml.title article.title
          xml.link request.protocol+request.host+article.images.first.image.url(:detail) if article.images.first
        end
